        ...
        <div class="container">
          ...
          <div class="grid-3">
            <div class="card hover-lift fade-in-up" v-for="(album, i) in filteredItems" :key="i" @click="toggleExpand(i)" style="cursor:pointer;">
              <div style="height:180px;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#1A5FB4,#0D47A1);border-radius:var(--radius-md) var(--radius-md) 0 0;position:relative;overflow:hidden;">
              ...
              <div class="card-body">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:0.5rem;">
                  ...
                  <span class="card-tag" style="padding:0.2rem 0.6rem;border-radius:0;font-size:0.75rem;color:var(--primary);background:rgba(255,107,53,0.1);font-weight:600;">{{ album.type }}</span>
                </div>
  ...
  template: `
    <div class="page-content">
      ...
      <section class="content-section">
        <div class="container">
          <!-- Featured Highlight -->
          <div class="card fade-in-up" style="margin-bottom:2rem;overflow:hidden;border-radius:0;">
            <div style="display:grid;grid-template-columns:1fr 1.2fr;min-height:320px;">
              ...
              <div class="card-body" style="display:flex;flex-direction:column;justify-content:center;padding:2.5rem;">
                <span class="card-tag" style="align-self:flex-start;padding:4px 12px;border-radius:0;font-size:0.82rem;font-weight:600;color:var(--red);background:var(--red-glow);margin-bottom:12px;">{{ featured.type }}</span>
                ...
                <div style="background:var(--gray-50);border-radius:0;padding:14px 18px;border:1px solid var(--gray-100);">
                  <div style="display:flex;align-items:center;gap:12px;">
                    <div @click.stop="toggleFeaturedPlay" style="width:44px;height:44px;border-radius:0;background:var(--grad-warm);display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0;box-shadow:var(--shadow-glow-red);transition:transform 0.2s;">
                    ...
                    <div style="flex:1;">
                      ...
                      <div style="background:var(--gray-200);border-radius:0;height:5px;overflow:hidden;">
                        <div style="height:100%;background:var(--grad-warm);border-radius:0;transition:width 0.3s;" :style="{ width: featuredProgress + '%' }"></div>
                      </div>
                    </div>
                    <!-- Visualizer Bars -->
            ...
            <div class="card hover-lift fade-in-up" v-for="(work, i) in soloWorks" :key="i">
              <div class="card-body" style="padding:1.5rem;">
                <div style="display:flex;gap:1rem;align-items:flex-start;">
                  <div style="width:64px;height:64px;border-radius:0;background:linear-gradient(135deg,rgba(255,107,53,0.15),rgba(212,168,83,0.15));display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:1.5rem;">·</div>
                  <div style="flex:1;">
                    ...
                    <span class="card-tag" style="display:inline-block;padding:0.15rem 0.5rem;border-radius:0;font-size:0.75rem;color:var(--primary);background:rgba(255,107,53,0.1);margin-bottom:0.5rem;">{{ work.type }}</span>
        ...
        <div class="container">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;min-height:280px;">
              <div style="background:linear-gradient(135deg,#1a1a2e,#16213e);display:flex;align-items:center;justify-content:center;position:relative;">
                ...
                <div style="position:absolute;bottom:1rem;left:1rem;right:1rem;display:flex;justify-content:space-between;align-items:center;">
                  ...
                  <span style="background:rgba(255,107,53,0.9);color:#fff;padding:0.35rem 1rem;border-radius:0;font-size:0.9rem;font-weight:600;">{{ sortedFancams[0].views }}</span>
                </div>
              </div>
              <div class="card-body" style="display:flex;flex-direction:column;justify-content:center;padding:2.5rem;">
          ...
          <div class="grid-3">
            <div class="card hover-lift fade-in-up" v-for="(cam, i) in sortedFancams.slice(1)" :key="i">
              <div style="height:160px;background:linear-gradient(135deg,#1a1a2e,#16213e);display:flex;align-items:center;justify-content:center;position:relative;border-radius:var(--radius-md) var(--radius-md) 0 0;">
                <span style="font-size:3rem;">·</span>
                <div style="position:absolute;top:0.75rem;right:0.75rem;background:rgba(0,0,0,0.7);color:#fff;padding:0.2rem 0.6rem;border-radius:var(--radius-sm);font-size:0.8rem;font-weight:600;">{{ cam.views }}</div>
                <div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.3);opacity:0;transition:opacity 0.3s;cursor:pointer;border-radius:var(--radius-md) var(--radius-md) 0 0;" class="play-overlay">
