  ...
  template: `
    <div class="page-content">
      ...
      <section class="content-section" style="background:var(--bg-secondary);">
        <div class="container">
          <div class="photo-grid photo-grid-4 fade-in-up">
            <div class="photo-item" :class="p.span || ''" v-for="(p, i) in stagePhotos" :key="i" style="border-radius:0.5rem;overflow:hidden;">
      ...
      <section class="content-section">
        <div class="container">
          ...
          <div class="photo-grid photo-grid-4 fade-in-up" style="gap:0.75rem;">
            <div class="photo-item" v-for="(p, i) in dailyPhotos" :key="i" style="border-radius:0.5rem;overflow:hidden;">
        ...
        <div class="container">
          ...
          <div class="card fade-in-up" style="margin-bottom:2rem;overflow:hidden;">
            <div style="height:360px;position:relative;">
              ...
              <div style="position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;background:rgba(0,0,0,0.4);">
                <a href="https://music.163.com/#/mv?id=10943184" target="_blank" style="width:80px;height:80px;border-radius:50%;background:rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center;cursor:pointer;backdrop-filter:blur(10px);border:2px solid rgba(255,255,255,0.3);transition:all 0.3s;text-decoration:none;">
          ...
          <div class="grid-2">
            <div class="card hover-lift fade-in-up" v-for="(mv, i) in mvs" :key="i">
              <div style="height:220px;position:relative;border-radius:0.5rem 0.5rem 0 0;overflow:hidden;">
                ...
                <div v-if="mv.duration" style="position:absolute;bottom:0.75rem;right:0.75rem;background:rgba(0,0,0,0.7);color:#fff;padding:0.2rem 0.6rem;border-radius:0.25rem;font-size:0.8rem;">
                  {{ mv.duration }}
                </div>
              </div>
              <div class="card-body">
        ...
        <div class="container">
          <div class="grid-3">
            <div class="card hover-lift fade-in-up" v-for="(video, i) in danceVideos" :key="i">
              <div style="height:180px;position:relative;border-radius:0.5rem 0.5rem 0 0;overflow:hidden;">
                <img :src="video.img" :alt="video.title" style="width:100%;height:100%;object-fit:cover;">
                <div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.3);opacity:0;transition:opacity 0.3s;cursor:pointer;">
                  <div style="width:48px;height:48px;border-radius:50%;background:rgba(255,255,255,0.2);display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);">
                    <span style="color:#fff;font-size:1.2rem;margin-left:2px;">▶</span>
                  </div>
                </div>
                <div style="position:absolute;bottom:0.75rem;right:0.75rem;background:rgba(0,0,0,0.8);color:#fff;padding:0.2rem 0.5rem;border-radius:0.25rem;font-size:0.8rem;font-weight:600;">
                  {{ video.duration }}
                </div>
                <div style="position:absolute;top:0.75rem;left:0.75rem;background:rgba(255,107,53,0.9);color:#fff;padding:0.2rem 0.5rem;border-radius:0.25rem;font-size:0.75rem;font-weight:600;">
                  {{ video.type }}
                </div>
              </div>
              <div class="card-body">
            ...
            <div class="card hover-lift fade-in-up" v-for="(wp, i) in filteredItems" :key="i" style="overflow:hidden;">
              <div style="position:relative;overflow:hidden;">
                ...
                <div style="position:absolute;top:0.75rem;left:0.75rem;">
                  <span style="background:var(--red);color:#fff;padding:0.2rem 0.6rem;border-radius:var(--radius-sm);font-size:0.75rem;font-weight:600;">{{ getCategoryLabel(wp.category) }}</span>
                </div>
              </div>
              <div class="card-body">
