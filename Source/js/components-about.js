    ...
    <div class="page-content">
      ...
      <section class="content-section">
        <div class="container" style="max-width:700px;">
          <div class="card fade-in-up" style="padding:36px;border-radius:var(--radius-lg);">
          ...
          <div class="card fade-in-up" style="padding:28px;border-radius:var(--radius-lg);margin-top:24px;border-left:3px solid var(--gray-400);">
