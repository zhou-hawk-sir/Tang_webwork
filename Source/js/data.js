...
window.SiteData = {
  ...
  profile: {
    ...
    awards: [
      // ===== 个人获奖与荣誉（2025–2026） =====
      { year: '2025', title: 'AAA 亚洲艺人奖', category: 'Grand Presence of K-Pop（个人大赏）', result: '获奖', work: '个人', note: '2025.12.06 台湾高雄，首个个人主流颁奖礼奖项，感言使用中/英/韩三语' },
      { year: '2025', title: 'MAMA Awards', category: "Worldwide Fan's Choice（粉丝选择奖）", result: '获奖', work: 'Stray Kids', note: '2025.11.28' },
      { year: '2025', title: 'Launchmetrics MIV', category: '媒体影响力价值', result: '获奖', work: '个人', note: '20.1M，全球艺人第一（连续两年霸榜）' },
      { year: '2026', title: '韩法建交140周年', category: '名誉大使', result: '获奖', work: '个人', note: '2026.03.05，法国驻韩大使馆任命' },
      { year: '2026', title: 'MUSIC AWARDS JAPAN', category: 'Best Global Hit From Japan', result: '获奖', work: '《ReawakeR》(feat. LiSA)', note: '第一轮投票第一，唯一入围主流奖项的非虚拟K‑Pop艺人' },
      { year: '2026', title: 'MUSIC AWARDS JAPAN', category: 'Best Cross-Border Collaboration Song', result: '提名', work: '《ReawakeR》(feat. LiSA)' },
      { year: '2026', title: 'MUSIC AWARDS JAPAN', category: 'Best Japanese Song in Europe', result: '提名', work: '《ReawakeR》(feat. LiSA)' },
      { year: '2026', title: 'Crunchyroll Anime Awards', category: '最佳动漫歌曲', result: '提名', work: '《ReawakeR》' },
      { year: '2026', title: 'Crunchyroll Anime Awards', category: '最佳动漫OP', result: '提名', work: '《ReawakeR》' },
      { year: '2026', title: '巴黎时装周', category: '最具影响力男艺人', result: '获奖', work: '2026秋冬巴黎时装周', note: '社交提及量最高K‑Pop艺人、奢侈品曝光量最高男艺人' },
      { year: '2026', title: '《Esquire》时尚榜单', category: '音乐界最时尚50位男士', result: '获奖', work: '个人', note: '第5位（2026.02）' },
      // ===== 随组合Stray Kids获奖（2025–2026） =====
      { year: '2025', title: 'MAMA Awards', category: '年度专辑大赏', result: '获奖', work: '《KARMA》' },
      { year: '2025', title: 'MAMA Awards', category: '本赏', result: '获奖', work: 'Stray Kids' },
      { year: '2025', title: 'MAMA Awards', category: '粉丝选择TOP10', result: '获奖', work: 'Stray Kids' },
      { year: '2025', title: 'AAA 亚洲艺人奖', category: '年度专辑', result: '获奖', work: 'Stray Kids' },
      { year: '2025', title: 'AAA 亚洲艺人奖', category: '年度歌手', result: '获奖', work: 'Stray Kids' },
      { year: '2025', title: 'AAA 亚洲艺人奖', category: 'BEST K‑Pop Record', result: '获奖', work: 'Stray Kids' },
      { year: '2025', title: 'AAA 亚洲艺人奖', category: '最佳艺人', result: '获奖', work: 'Stray Kids' },
      { year: '2025', title: '金唱片奖', category: '专辑部门本赏（第39届）', result: '获奖', work: 'Stray Kids' },
      { year: '2025', title: '首尔歌谣大赏', category: '本赏', result: '获奖', work: 'Stray Kids' },
      { year: '2026', title: '日本金唱片大奖（第40届）', category: '年度最佳艺人', result: '获奖', work: 'Stray Kids', note: '海外艺人获奖最多纪录' },
      { year: '2026', title: '日本金唱片大奖（第40届）', category: '年度最佳专辑', result: '获奖', work: 'Stray Kids' },
      { year: '2026', title: '日本金唱片大奖（第40届）', category: '年度最佳音乐录像带', result: '获奖', work: 'Stray Kids' },
      { year: '2026', title: '日本金唱片大奖（第40届）', category: '三大最佳专辑', result: '获奖', work: 'Stray Kids' },
      { year: '2026', title: 'iHeartRadio Music Awards', category: 'K‑Pop年度组合', result: '获奖', work: 'Stray Kids', note: '连续三年获奖，五代团体首位' },
      { year: '2026', title: 'Hanteo Music Awards', category: '最佳专辑大赏（Daesang）', result: '获奖', work: 'Stray Kids', note: '四代团大赏最多（19个）' },
      { year: '2026', title: 'Hanteo Music Awards', category: '其他6项大奖', result: '获奖', work: 'Stray Kids' },
      // ===== 历史获奖记录 =====
    ...
    fashion: {
      title: '时尚风格', description: 'Felix以其独特的时尚品味受到各大品牌青睐，是首位登上VOGUE Korea闭年刊的五代男偶像，2026秋冬巴黎时装周全球最具影响力男艺人、社交提及量最高K‑Pop艺人、奢侈品曝光量最高男艺人。',
      styles: [
      ...
      brands: ['Louis Vuitton（全球代言人）', '阿迪达斯（全球全线代言人）', 'HERA 赫妍（全球代言人）', 'Gongcha 贡茶（全球代言人）', 'Samsung Galaxy（全球代言人）']
    },
    // ===== 代言与官方身份 =====
    endorsements: [
      { brand: 'Louis Vuitton', role: '全球代言人', year: '2023-至今', type: '时尚' },
      { brand: '阿迪达斯', role: '全球全线代言人', year: '2026-至今', type: '运动' },
      { brand: 'HERA 赫妍', role: '全球代言人', year: '2025-至今', type: '美妆' },
      { brand: 'Gongcha 贡茶', role: '全球代言人', year: '2025-至今', type: '餐饮' },
      { brand: 'Samsung Galaxy', role: '全球代言人', year: '2025-至今', type: '科技' },
      { brand: 'UNICEF', role: '亲善大使', year: '2024-至今', type: '公益' },
      { brand: '韩法建交140周年', role: '名誉大使', year: '2026', type: '外交' }
    ],
    // ===== 大量照片数据 =====
    photos: {
      hero: [
  ...
  variety: {
    ...
    commercials: [
      { brand: 'Louis Vuitton', role: '全球代言人', year: '2023-至今', description: 'Louis Vuitton全球代言人，多次出席巴黎时装周等品牌活动，2026秋冬巴黎时装周最具影响力男艺人。' },
      { brand: '阿迪达斯', role: '全球全线代言人', year: '2026-至今', description: '阿迪达斯全球全线代言人，2026年全球广告官宣。' },
      { brand: 'HERA 赫妍', role: '全球代言人', year: '2025-至今', description: '韩国高端美妆品牌HERA全球代言人。' },
      { brand: 'Gongcha 贡茶', role: '全球代言人', year: '2025-至今', description: '贡茶全球代言人，展现清新活力形象。' },
      { brand: 'Samsung Galaxy', role: '全球代言人', year: '2025-至今', description: '三星Galaxy全球代言人，参与新品发布与全球推广。' }
    ],
    behind: [
