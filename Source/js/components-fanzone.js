  ...
  template: `
    <div class="page-content">
      ...
      <section class="content-section">
        <div class="container">
          <!-- Quiz In Progress -->
          <div class="card fade-in-up" v-if="!quizFinished" style="max-width:700px;margin:0 auto;border-radius:var(--radius-lg);">
            <div class="card-body" style="padding:32px;">
              ...
              <div style="margin-bottom:28px;">
                ...
                <div style="background:var(--gray-100);border-radius:var(--radius-full);height:8px;overflow:hidden;">
                  <div style="height:100%;border-radius:var(--radius-full);background:var(--grad-primary);transition:width 0.5s ease;"
          ...
          <!-- Quiz Result -->
          <div class="card fade-in-up" v-else style="max-width:700px;margin:0 auto;border-radius:var(--radius-lg);">
            ...
            <div class="card hover-lift fade-in-up" v-for="(item, i) in filteredItems" :key="i" style="overflow:hidden;">
              <div style="height:200px;position:relative;overflow:hidden;">
                ...
                <div style="position:absolute;top:0.75rem;left:0.75rem;">
                  <span style="background:var(--red);color:#fff;padding:0.2rem 0.6rem;border-radius:var(--radius-sm);font-size:0.75rem;font-weight:600;">{{ getCategoryLabel(item.category) }}</span>
                </div>
                <div style="position:absolute;bottom:0.75rem;right:0.75rem;background:rgba(0,0,0,0.7);color:#fff;padding:0.2rem 0.5rem;border-radius:var(--radius-sm);font-size:0.75rem;">
                  {{ item.resolution }}
                </div>
              </div>
              <div class="card-body">
