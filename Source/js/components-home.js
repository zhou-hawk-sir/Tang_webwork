...
window.Components.Home = {
  template: `
    <div class="page-home">
      ...
      <section class="content-section section-dark">
        <div class="container">
          ...
          <div style="max-width:520px;margin:0 auto 36px">
            <div class="audio-player" style="background:rgba(255,255,255,0.04);border-color:rgba(255,255,255,0.08);border-radius:var(--radius-lg);">
              <img src="Images/杂志2.jpg" alt="" style="width:44px;height:44px;border-radius:8px;">
      ...
      <section class="content-section">
        <div class="container">
          <div class="section-header text-center">
            <p class="t-sub">FAN ZONE</p>
            <h2 class="section-title">粉丝乐园</h2>
            <div class="section-line" style="margin:12px auto 0"></div>
          </div>
          <div class="fanzone-grid">
            <router-link to="/fanzone" class="fanzone-card">
              <span class="fanzone-icon">📰</span>
              <h4>最新资讯</h4>
              <p>关注Felix的每一个瞬间</p>
            </router-link>
            <router-link to="/fanzone/quiz" class="fanzone-card">
              <span class="fanzone-icon">🧠</span>
              <h4>趣味测验</h4>
              <p>测试你对Felix的了解</p>
            </router-link>
            <router-link to="/gallery/wallpapers" class="fanzone-card">
              <span class="fanzone-icon">🖼️</span>
              <h4>壁纸下载</h4>
              <p>精美壁纸等你下载</p>
            </router-link>
            <router-link to="/about" class="fanzone-card">
              <span class="fanzone-icon">ℹ️</span>
              <h4>关于本站</h4>
              <p>网站宗旨与介绍</p>
            </router-link>
          </div>
  ...
  data() {
    return {
      ...
      progressTimer: null,
      slides: [
        { img: 'Images/fliex.jpg', title: '李龙馥', desc: 'Lee Felix · Stray Kids', tag: '概念写真' },
        { img: 'Images/舞台1.jpg', title: '舞台光芒', desc: '演唱会现场震撼演出', tag: 'STAGE' },
        { img: 'Images/杂志1.jpg', title: '时尚风采', desc: 'Louis Vuitton 全球品牌大使', tag: 'FASHION' },
        { img: 'Images/F1.jpg', title: 'F1上海站', desc: '时尚与运动的碰撞', tag: 'EVENT' },
        { img: 'Images/舞台2.jpg', title: '舞台实力', desc: '力量与优雅的完美融合', tag: 'DANCE' },
        { img: 'Images/儿童.jpg', title: 'UNICEF亲善大使', desc: '传递温暖与希望', tag: 'CHARITY' },
      ],
